        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    //Vector3 jitterOffset = new Vector3(RandomPos.Range(-.25f, .25f), RandomPos.Range(-.25f, .25f), 0);
                    ...
                    //matrix = Matrix4x4.TRS(jitterOffset, Quaternion.Euler(0, 0, RandomPos.Range(-5f, 5f)), Vector3.one * randomScale);
