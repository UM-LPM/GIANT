...
{
    public class CompetitionTeamOrganizatorOneTeamXIndividuals : CompetitionTeamOrganizator
    {
        [SerializeField] private int TeamSize = 2;

        public override List<CompetitionTeam> OrganizeTeams(Individual[] individuals, CompetitionPlayer[] competitionPlayers)
        {
