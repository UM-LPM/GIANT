...
{
    public class Soccer2D2vs2MatchSpawner : MatchSpawner
    {
        [Header("Soccer 2vs2 Match Configuration")]
        [SerializeField] public Transform[] SpawnPointsBlue;
        [SerializeField] public Transform[] SpawnPointsPurple;

        [Header("Soccer 2vs2 Match Agent Configuration")]
        ...
        public override void validateSpawnConditions(EnvironmentControllerBase environmentController)
        {
            ...
            {
                throw new System.Exception("Each team should have 2 individual");
            }
