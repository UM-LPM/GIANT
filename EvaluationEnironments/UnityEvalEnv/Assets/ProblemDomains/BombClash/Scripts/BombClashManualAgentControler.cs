...
{
    [CreateAssetMenu(fileName = "BombClashManualAgentController", menuName = "AgentControllers/ManualAgentControllers/BombClashManualAgentController")]
    public class BombClashManualAgentController : ManualAgentController
    {
