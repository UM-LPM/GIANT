...
namespace Problems.PlanetConquest2
{
    public class AgentStatBars : MonoBehaviour
    {
        ...
        {
            HealthBar.fillAmount = health / PlanetConquest2EnvironmentController.MAX_AGENT_HEALTH;
            EnergyBar.fillAmount = energy / PlanetConquest2EnvironmentController.MAX_AGENT_ENERGY;
        }
    }
}