...
{
    public class MarioMatchSpawner : MatchSpawner
    {
        ...
        public override void validateSpawnConditions(EnvironmentControllerBase environmentController)
        {
            ...
            {
                throw new System.Exception("Team should have 1 individual");
            }

            if (environmentController.Match.Teams[0].Individuals[0].AgentControllers.Length != 1)
            {
                throw new System.Exception("Individual should have 1 agent controller");
            }
