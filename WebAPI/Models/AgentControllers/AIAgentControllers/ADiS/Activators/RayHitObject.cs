...
namespace AgentControllers.AIAgentControllers.ADiSAgentController
{
    ...
    public class RayHitObject : Activator
    {
        ...
        public RayHitObject(string guid, List<WebAPI.Models.Property>? properties, Position? position)
            : base(guid, "RayHitObject", properties, position)
        {
        }
