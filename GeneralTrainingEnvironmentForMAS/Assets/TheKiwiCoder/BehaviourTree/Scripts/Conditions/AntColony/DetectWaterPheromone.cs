...
public class DetectWaterPheromone : ConditionNode
{
    ...
    {
        return DetectPheromone(context.transform.position, PheromoneType.Water, context.gameObject.GetComponentInParent<AntAgentComponent>().detectionRadius);
    }
