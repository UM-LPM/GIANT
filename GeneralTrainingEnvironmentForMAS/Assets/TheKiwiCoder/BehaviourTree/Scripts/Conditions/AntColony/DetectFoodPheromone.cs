...
public class DetectFoodPheromone : ConditionNode
{
    ...
    {
        return DetectPheromone(context.transform.position, PheromoneType.Food, context.gameObject.GetComponentInParent<AntAgentComponent>().detectionRadius);
    }
